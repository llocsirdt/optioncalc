...
function optsFor(v) {
  ...
  VC.assertForwarded(v, Object.keys(o), 'sweep-cover-arming optsFor',
    ['capitalRecapture', 'openAlternateEvery', 'creditCoverFrac', 'coverToStackMinFrac', 'continuousCoverArmFrac', 'continuousCoverOppRatio', 'coverGeometry', 'wingConvert', 'wingMinRatio', 'wingAfterMin', 'wingBudgetFrac', 'wingNaked', 'wingUpsideLambda']);
  return o;
}
