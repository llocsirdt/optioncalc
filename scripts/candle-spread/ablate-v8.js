...
function optsFor(v) {
  ...
  VC.assertForwarded(v, Object.keys(o), 'ablate-v8 optsFor',
    ['softCap', 'hardCap', 'riskCap', 'capitalCeiling', 'exemptTrendStack', 'proactiveCoverFrac', 'lossTarget', 'lossMax', 'capitalRecapture', 'openAlternateEvery', 'creditCoverFrac', 'coverToStackMinFrac']);
  return o;
}
